...
class MoCoHead(nn.Module):
    ...
    def forward(self, images, captions):
        ...
        low_level_t_feature,high_level_t_feature_global,high_level_t_feature_local = self.t_encoder_q(captions)
        
        v_embed = high_level_v_feature_global
        t_embed = high_level_t_feature_global
        ...
        if self.training:
            ...
            with torch.no_grad():
                ...
                _,_,_,v_embed_k,_ = self.v_encoder_k(images)
                ...
                _,t_embed_k,_ = self.t_encoder_k(captions)
                if self.fc:
            ...
            low_level_t_feature = self.v_embed_low_layer(low_level_t_feature)
