...
# BERT
# -----------------------------------------------------------------------------
_C.MODEL.NUM_BERT_LAYERS = 4
_C.MODEL.NUM_BERT_HEAD = 8
...
_C.BERT_PATH = None
_C.SWINV2_PATH = r"F:\preTrainedModels\swinv2-small-patch4-window16-256"
_C.HIDDEN_SIZE = 768

_C.MODEL.VISUAL_POOLER = False
_C.MODEL.FREEZE_BERT = True

_C.RANKING_MARGIN = 0.2

_C.LOSS_TYPE = ("instance_loss","infonce_loss","global_align_loss")
_C.NUM_BERT_LAYERS = 6

_C.CLIORA = CN()
_C.CLIORA.MARGIN_RE = 1.0
_C.CLIORA.NEG_SAMPLE_NUM = 100
_C.CLIORA.ALPHA_VG = 1.0
_C.CLIORA.MARGIN_C = 1.0
_C.CLIORA.ALPHA_C = 1.0
_C.CLIORA.NEG_VOCAB_SIZE = 30000
_C.CLIORA.NEG_FREQ = 0.75
_C.CLIORA.PROJ_DIM = 768
